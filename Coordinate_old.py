...
class Coordinate:
	...
	def __init__(self, coordinate_x, coordinate_y):
		...
		if (self.coordinate_x == 4 and self.coordinate_y == 1):
			self.reward = 10
		if (self.coordinate_x == 4 and self.coordinate_y == 3):
			self.reward = 5
		...
		for action in [(0, 1), (1, 0), (0, -1), (-1, 0)]:
			self.actionset.append(Action(self.coordinate_x, self.coordinate_y, action))
	...
	def show_actionset(self):
		print("The coordinate {} {} contains the following actions: ".format(self.coordinate_x, self.coordinate_y))

		for action in self.actionset:
			print("Moving {} has a value of {} and has been chosen {} times".format(action.action, action.value, action.count))
